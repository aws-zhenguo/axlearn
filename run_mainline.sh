...
sudo dpkg -i /fsx/apoorvgu/aws-neuronx-runtime-lib-2.x.19946.0-471ad7ed2.deb
sudo dpkg -i /fsx/apoorvgu/aws-neuronx-collectives-2.x.21304.0-36af3830a.deb
sudo dpkg -i /fsx/apoorvgu/axlearn/aws-neuronx-dkms_2.x.3951.0_amd64.deb
hostname
ARTIFACTS_PATH="/fsx/czhenguo/Projects/fruitstand/runs/artifacts/test_training"
# TIMESTAMP=$(date +"%y%m%d%H%M%S")
TIMESTAMP="250108230119"
